            ...
            <div class="offcanvas-lg offcanvas-start sticky-lg-top pe-lg-3 pe-xl-4" id="accountSidebar">
              ...
              <div class="offcanvas-body d-block pt-2 pt-lg-4 pb-lg-0">
                <nav class="list-group list-group-borderless">
                  <a class="list-group-item list-group-item-action d-flex align-items-center active" aria-current="page" href="{{ route('account-profile.user') }}">
          ...
          <div class="p-4 bg-white shadow rounded-lg">
            <table class="table">
              <tbody>
                ...
                @if($field !== 'password')
                <tr>
                  <td class="font-weight-bold text-capitalize">{{ str_replace('_', ' ', $field) }}:</td>
                  <td>
                    @if($field == 'photo')
                      @if(auth()->user()->photo)
                        <img src="{{ Storage::url(auth()->user()->photo) }}" alt="Profile Photo" class="rounded-circle" width="50">
