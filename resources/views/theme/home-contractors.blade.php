...
<!-- Mirrored from finder-html.createx.studio/home-contractors.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jan 2025 11:23:04 GMT -->
              ...
              <li class="nav-item dropdown py-lg-2 me-lg-n1 me-xl-0">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="dropend">
                    ...
                    <ul class="dropdown-menu">
                      <li><a class="dropdown-item" href="blog-layout-v1.html">Blog Layout v.1</a></li>
                      <li><a class="dropdown-item" href="blog-layout-v2.html">Blog Layout v.2</a></li>
                      <li><a class="dropdown-item" href="blog-layout-v3.html">Blog Layout v.3</a></li>
                      <li><a class="dropdown-item" href="blog-layout-v4.html">Blog Layout v.4</a></li>
                  ...
                  <li class="dropend">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li><a class="dropdown-item" href="help-topics-v3.html">Help Topics v.3</a></li>
                      ...
                      <li><a class="dropdown-item" href="help-single-article-v3.html">Help Single Article v.3</a></li>
                    </ul>
                  </li>
                  <li class="dropend">
                    ...
                    <ul class="dropdown-menu">
                      <li><a class="dropdown-item" href="404-bg-image.html">Background Image (Real Estate)</a></li>
                      <li><a class="dropdown-item" href="404-icon.html">Icon Image (Cars)</a></li>
                      <li><a class="dropdown-item" href="404-split-screen.html">Split Screen (Contractors)</a></li>
                      <li><a class="dropdown-item" href="404-illustration.html">Illustration (City Guide)</a></li>
                    </ul>
                  </li>
      ...
      <section class="position-relative bg-info overflow-hidden py-5">
        <div class="container position-relative z-2 pb-2 py-sm-4 py-md-5 my-xxl-4">
          <div class="mx-auto py-lg-4 py-xl-5" style="max-width: 630px">
            <h1 class="display-4 text-white text-center pb-2 pb-md-0 mb-4 mb-md-5">Explore top-rated certified pros nearby</h1>
              ...
              <div class="d-flex flex-column flex-md-row gap-3 p-1">
                <div class="d-flex flex-column flex-sm-row w-100 gap-2 gap-sm-3">
                  ...
                  <div class="position-relative w-100" style="max-width: 150px">
                    <i class="fi-map-pin position-absolute top-50 start-0 translate-middle-y fs-xl text-secondary-emphasis ms-2"></i>
                    <input type="text" class="form-control form-control-lg form-icon-start border-0 rounded-0 pe-0" placeholder="Zip code" required="">
                  </div>
                </div>
            ...
            <div class="swiper-slide">
              <article class="card hover-effect-scale hover-effect-opacity">
                <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                  ...
                  <h3 class="h5 position-absolute bottom-0 start-0 d-flex align-items-end w-100 h-100 text-white z-1 p-3 mb-0">One-time cleaning service</h3>
                ...
                <div class="card-body p-3">
                  <div class="d-flex align-items-center gap-3">
                    ...
                    <a class="stretched-link fs-sm text-dark-emphasis text-decoration-none" href="listings-contractors.html">From $80</a>
              ...
              <article class="card hover-effect-scale hover-effect-opacity">
                ...
                <div class="card-body p-3">
                  <div class="d-flex align-items-center gap-3">
                    ...
                    <a class="stretched-link fs-sm text-dark-emphasis text-decoration-none" href="listings-contractors.html">From $250</a>
                    <button type="button" class="btn btn-outline-dark position-relative z-2 ms-auto">Book now</button>
                  </div>
                </div>
              </article>
            ...
            <div class="swiper-slide">
              <article class="card hover-effect-scale hover-effect-opacity">
                <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                  ...
                  <h3 class="h5 position-absolute bottom-0 start-0 d-flex align-items-end w-100 h-100 text-white z-1 p-3 mb-0">Fence installation &amp; repair</h3>
                  <span class="position-absolute top-0 start-0 w-100 h-100" style="background: linear-gradient(1deg, rgba(33,42,54, .75) 0.33%, rgba(33,42,54, 0) 45.72%)"></span>
                </div>
                <div class="card-body p-3">
                  <div class="d-flex align-items-center gap-3">
                    ...
                    <a class="stretched-link fs-sm text-dark-emphasis text-decoration-none" href="listings-contractors.html">From $310</a>
                    <button type="button" class="btn btn-outline-dark position-relative z-2 ms-auto">Book now</button>
                  </div>
                </div>
              </article>
      ...
      <div class="container pb-md-2">
        ...
        <div class="accordion row pt-4 pt-sm-5 mt-3 mt-sm-0" id="footerLinks">
          <div class="col-md-4 col-lg-5 mb-4 mb-sm-5 mb-md-0">
            <a class="d-inline-flex align-items-center text-dark-emphasis text-decoration-none mb-3" href="index.html">
          ...
          <div class="col-sm-8 col-md-5 col-lg-4">
            <div class="accordion-item border-0">
              <h6 class="accordion-header" id="categoryLinksHeading">
                ...
                <button type="button" class="accordion-button collapsed py-3 d-sm-none" data-bs-toggle="collapse" data-bs-target="#categoryLinks" aria-expanded="false" aria-controls="categoryLinks">Popular categories</button>
              </h6>
                ...
                <div class="row row-cols-2">
                  <div class="col">
                    <ul class="nav flex-column gap-2 pt-sm-1 pt-lg-2 pb-3 pb-sm-0 mt-n1 mb-1 mb-sm-0">
                      <li class="pt-1">
                        <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Air conditioning</a>
                      </li>
                      <li class="pt-1">
                        <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Painting</a>
                      </li>
                      <li class="pt-1">
                        <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Electrician</a>
                      </li>
                      <li class="pt-1">
                  ...
                  <div class="col">
                    <ul class="nav flex-column gap-2 pt-sm-1 pt-lg-2 pb-3 pb-sm-0 mt-n1 mb-1 mb-sm-0">
                      ...
                      <li class="pt-1">
                        <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Heating &amp; furnace</a>
                      </li>
                      <li class="pt-1">
                        <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Carpentry</a>
                      </li>
                      <li class="pt-1">
                        <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Flooring</a>
                      </li>
                      <li class="pt-1">
                        <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Pest control</a>
                      </li>
                      <li class="pt-1">
                        <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Landscaping</a>
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <div class="d-md-flex align-items-center py-4 pt-sm-5 mt-3 mt-sm-0">
          ...
          <p class="text-body-secondary fs-sm text-center text-md-start mb-0 me-md-4 order-md-1">© All rights reserved. Made by <a class="text-body fw-medium text-decoration-none hover-effect-underline" href="https://createx.studio/" target="_blank" rel="noreferrer">Createx Studio</a></p>
        </div>
      </div>
    </footer>
...
<!-- Mirrored from finder-html.createx.studio/home-contractors.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jan 2025 11:25:09 GMT -->
</html>